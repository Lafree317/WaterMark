...
- (void)photoPickerClickTickButton:(UIButton *)tickButton{
    ...
    [self savePhoto:pickerImageView asset:asset row:row];

}

// 选中图片方法
- (void)savePhoto:(MLPhotoPickerImageView *)pickerImageView asset:(MLSelectPhotoAssets *)asset row:(NSInteger)row{
    // 如果没有就添加到数组里面，存在就移除
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    MLSelectPhotoPickerCollectionViewCell *cell = (MLSelectPhotoPickerCollectionViewCell *) [self cellForItemAtIndexPath:indexPath];
     MLPhotoPickerImageView *pickerImageView = [cell.contentView.subviews lastObject];
    
    [self savePhoto:pickerImageView asset:asset row:indexPath.row];
...
//    }
//    
//    [self photoPickerClickTickButton:nil];
